...
<head>
    ...
    <title>Tapal Kuda | Kopi Tubruk Robusta</title>
    ...
    <div class="wadah-breadcrumb">
        <nav class="navigasi-breadcrumb" aria-label="breadcrumb">
            <ul class="breadcrumb">
                ...
                <li>Coffe</li>
                <li class="aktif">Kopi Tubruk Robusta</li>
            </ul>
        </nav>
    </div>
    ...
    <div class="wadah-isi">
        <div class="kontainer-produk">
            ...
            <div class="kolom-detail">
                ...
                <p>
                    Kopi Tubruk Robusta adalah jenis minuman kopi tradisional Indonesia yang dibuat dengan menyeduh
                    langsung bubuk kopi robusta bersama air panas tanpa menggunakan penyaring. Kopi ini memiliki
                    karakter rasa yang kuat, cenderung pahit, dengan tingkat keasaman yang rendah, khas biji robusta.
                </p>
                ...
                <form>
                    <div class="modal-item">
                        ...
                        <div class="modal-item-price">
                            <p id="modalQuantity">x1</p> <!-- Update ini -->
                            <p id="totalPrice">Rp. 12,000</p> <!-- Update ini -->
                        </div>
                    </div>
