    ...
    <main>
      ...
      <section class="choose-dishes" aria-label="Choose Dishes">
        ...
        <div class="dishes-grid">
          ...
          <article class="dish-card">
            <img src="../../asset/Latte.jpg" alt="A cup of latte coffee with frothy milk on top and coffee beans"
              width="96" height="96" />
            <h3>Latte</h3>
            <p class="price">Rp. 15.000</p>
          ...
          <article class="dish-card">
            <img src="../../asset/SUKOMON.jpg"
              alt="A cup of black coffee with steam and a slice of lime on a white saucer" width="96" height="96" />
            <h3>Sukomon</h3>
            <p class="price">Rp. 20.000</p>
            <p class="available">20 available</p>
          </article>
      ...
      <ul class="order-list">
        <li>
          <img src="https://storage.googleapis.com/a1aa/image/8294678e-e685-4081-dce2-181e85ee96b9.jpg"
            alt="Small image of a cup of cappuccino coffee in a red cup on a saucer with coffee beans around" width="40"
            height="40" />
          <div class="order-info">
            <p class="name">Cappucino</p>
            <p class="price">Rp. 15.000</p>
            <input type="text" placeholder="Less sugar aja yaa" value="Less sugar aja yaa"
              aria-label="Order note for Cappucino" />
          </div>
        ...
        <li>
          <img src="https://storage.googleapis.com/a1aa/image/4ef37ba9-80d1-4e0f-3f08-904ef555fbae.jpg"
            alt="Small image of a glass of espresso coffee with coffee beans around on a table" width="40"
            height="40" />
          <div class="order-info">
        ...
        <li>
          <img src="https://storage.googleapis.com/a1aa/image/2b314b52-7258-4e5d-ffb3-3c33c84c8a61.jpg"
            alt="Small image of a blue cup of Kopi Tubruk Arabika coffee on saucer with coffee beans" width="40"
            height="40" />
          <div class="order-info">
          ...
          <div class="order-qty-delete">
            ...
            <button aria-label="Delete Kopi Tubruk Arabica order" type="button"><i
                class="fas fa-trash-alt"></i></button>
          </div>
        </li>
        <li>
          <img src="https://storage.googleapis.com/a1aa/image/fb37ce92-8a2e-4f08-5c15-471e9ea4ac5a.jpg"
            alt="Small image of a cup of latte coffee with frothy milk on top and coffee beans" width="40"
            height="40" />
          <div class="order-info">
