...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <div class="navbar-icons">
            <a href="keranjang.html" class="cart-icon" id="cart">
                <svg xmlns="http://www.w3.org/2000/svg" id="carts" width="27" height="27" fill="currentColor"
